...
interface OrigamiPostProcessProps {
  origamiName: string;
  origamiColor: string;
  handleOrigamiNameChange: (e: ChangeEvent<HTMLInputElement>) => void;
  handleOrigamiColorChange: (e: ChangeEvent<HTMLInputElement>) => void;
  sceneRef?: React.MutableRefObject<THREE.Scene | null>;
  cameraRef?: React.MutableRefObject<THREE.PerspectiveCamera | null>;
  rendererRef?: React.MutableRefObject<THREE.WebGLRenderer | null>;
  handleSetPreviewModel: (model: Model) => void;
}

export const OrigamiPostProcess: React.FC<OrigamiPostProcessProps> = ({
  origamiName,
  origamiColor,
  handleOrigamiNameChange,
  handleOrigamiColorChange,
  handleSetPreviewModel,
}) => {
  // 常に保持しておきたい変数
  ...
  const { handleDecideProcedure } = useRegisterOrigami({
    origamiName,
    origamiColor,
    sceneRef,
    cameraRef,
